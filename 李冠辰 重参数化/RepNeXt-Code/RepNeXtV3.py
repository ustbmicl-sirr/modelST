...
@register_model
def repnextv3_tiny(pretrained=False, **kwargs):
    return RepNeXt(depths=[3, 3, 9, 3], dims=[96, 192, 384, 768], **kwargs)


@register_model
def repnextv3_small(pretrained=False, **kwargs):
    return RepNeXt(depths=[3, 3, 27, 3], dims=[96, 192, 384, 768], **kwargs)


@register_model
def repnextv3_base(pretrained=False, in_22k=False, **kwargs):
    return RepNeXt(depths=[3, 3, 27, 3], dims=[128, 256, 512, 1024], **kwargs)


@register_model
def repnextv3_large(pretrained=False, in_22k=False, **kwargs):
    return RepNeXt(depths=[3, 3, 27, 3], dims=[192, 384, 768, 1536], **kwargs)


@register_model
def repnextv3_xlarge(pretrained=False, in_22k=False, **kwargs):
