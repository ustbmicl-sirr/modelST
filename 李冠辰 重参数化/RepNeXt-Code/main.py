...
from RepNeXt import repnext_tiny
from RepNeXtV2 import repnextv2_tiny
from RepNeXtV3 import repnextv3_tiny
...
def get_args_parser():
    parser = argparse.ArgumentParser('RepNeXt training and evaluation script for image classification', add_help=False)
    ...
    # Model parameters
    parser.add_argument('--model', default='repnext_tiny', type=str, metavar='MODEL', help='Name of model to train')
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/data/liguanchen/Datasets/Imagenet1K/', type=str, help='dataset path')
    ...
    parser.add_argument('--data_set', default='IMNET', choices=['CIFAR', 'IMNET', 'image_folder'], type=str, help='ImageNet dataset path')
